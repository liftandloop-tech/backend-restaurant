...
//router.patch("/transfer/table/:tableNumber", generalLimiter, requireRoles('Owner', 'Admin', 'Manager', 'Waiter','Cashier'), tableController.transferTable);
router.patch("/transfer/table/:tableNumber", requireRoles('Owner', 'Admin', 'Manager', 'Cashier', 'Waiter'),tableController.transferTable)
//router.patch("/complete/cleaning/:tableNumber", generalLimiter, requireRoles('Owner', 'Admin', 'Manager', 'Waiter','Cashier'), tableController.completeCleaning);
