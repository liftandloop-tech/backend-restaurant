...
exports. createKOTForOrder = async (req, res, next) => {
  try {
...
exports. markKOTPrinted = async (req, res, next) => {
...
exports. getKOTsForOrder = async (req, res, next) => {
  try {
...
exports. updateKOTItems = async (req, res, next) => {
  try {
